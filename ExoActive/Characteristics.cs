...
namespace ExoActive
{
    ...
    {
        [DataMember] private readonly Dictionary<string, ulong> characteristicDict = new();
        ...
        public void Remove(Enum characteristic)
        {
            ...
            if (characteristicDict.ContainsKey(key)) characteristicDict[key] &= ~value;
        }
        ...
        {
            return characteristicDict.GetValueOrDefault(Key<E>(), 0UL);
        }
