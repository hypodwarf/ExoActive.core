...
namespace Tests
{
    public class AttributeTests
    {
        ...
        {
            var x = new Type<bool, float>.Attribute("Jason", 1);
            var y = new Type<bool, string>.Attribute("Rohman", "Hi");
            var z = new Type<bool, Exception>.Attribute("Exception", new Exception());
            Assert.Pass();
        }
        ...
        {
            var a = new Type<bool, float>.Attribute("a", 1);
            var u = new Type<bool, float>.Attribute("u", 1);
            var v = new Type<bool, float>.Attribute("v", 1);
            var w = new Type<bool, float>.Attribute("w", 1);
            var x = new Type<bool, float>.Attribute("x", 1);
            var y = new Type<bool, float>.Attribute("y", 1);
            var z = new Type<bool, float>.Attribute("z", 1);
        ...
        {
            var a = new Type<bool, float>.Attribute("a", 1);
            var u = new Type<bool, float>.Attribute("u", 2);
            var v = new Type<bool, float>.Attribute("v", 1);
            var w = new Type<bool, float>.Attribute("w", 1);
            var x = new Type<bool, float>.Attribute("x", 3);
            var y = new Type<bool, float>.Attribute("y", 1);
            var z = new Type<bool, float>.Attribute("z", 1);
        ...
        {
            var x = new Type<bool, float>.Attribute("a", 1);
            var y = new Type<bool, float>.Attribute("u", 2);
            var z = new Type<bool, float>.Attribute("v", 3);
